    ...
    <>
      <div className="relative h-screen">
        ...
        <div className="relative w-full h-full flex flex-col items-center justify-start p-10 pt-20">
          <h1 className="text-white text-2xl md:text-4xl max-w-4xl text-center font-bold leading-normal">
            Soluções inovadoras para montagens industriais, caldeiraria, usinagem e equipamentos
            ecológicos.
          </h1>

          <h3 className="text-gray-300 text-lg md:text-2xl max-w-3xl text-center mt-8 md:mt-20">
